<#
.Synopsis
   Function to install DC agents
.DESCRIPTION
   According to domain controller type (RO or RW), you call out the appropriate function to install the required agents
.EXAMPLE
   Once is executed, you choose [1] for installing RO agents or [2] for installing RW agents
.AUTHOR
